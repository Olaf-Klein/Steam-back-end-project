                ...
                <div class="col-md-9 col-lg-5 mx-auto mx-lg-0">
                    <div class="signup-glass-panel app-glass">
                        <div class="d-flex align-items-center justify-content-between gap-3 mb-4">
                            <div>
                                <p class="signup-panel-label app-kicker mb-1">New account</p>
                        ...
                        <form id="registerForm" action="../Back-End/Auth.php" method="post" autocomplete="on">
                            <input type="hidden" name="action" value="register">
                            <div class="mb-3">
                                <label class="form-label" for="username">Username</label>
                                <input type="text" class="form-control signup-control" id="username" name="username"
                                    placeholder="Choose a username" autocomplete="username" minlength="3" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="email">Email address</label>
                                <input type="email" class="form-control signup-control" id="email" name="email"
                                    placeholder="you@example.com" autocomplete="email" required>
                            </div>
                            <div class="mb-1 position-relative">
                                <label class="form-label" for="password">Password</label>
                                <input type="password" class="form-control signup-control pe-5" id="password" name="password"
                                    placeholder="Create a secure password" autocomplete="new-password" minlength="6" required>
                            ...
                            <div class="mb-3">
                                <div class="progress signup-strength-track">
                                    <div id="strengthBar" class="password-strength-bar"></div>
                                </div>
                                <div id="strengthLabel" class="signup-strength-label mt-1">&nbsp;</div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="confirmPassword">Confirm password</label>
                                <input type="password" class="form-control signup-control" id="confirmPassword" name="confirmPassword"
